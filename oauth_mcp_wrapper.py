...
async def authorize(
    ...
    """OAuth authorization endpoint - Claude Custom Connector starts here"""
    ...
    # In production, validate against allowed redirect URIs
...
async def token(
    ...
    if grant_type == "authorization_code":
        ...
        access_token = create_access_token(
            data={"sub": client_id, "scope": auth_data["scope"]},
...
async def sse_endpoint(request: Request):
    ...
    # This assumes the actual MCP server runs on a different port
...
async def oauth_metadata():
    ...
    base_url = os.getenv("BASE_URL", "https://your.openprojectserver.com/mcp")
    return {
        "issuer": base_url,
...
if __name__ == "__main__":
    ...
    print(f"Authorization Endpoint: /oauth/authorize")
    print(f"Token Endpoint: /oauth/token")
